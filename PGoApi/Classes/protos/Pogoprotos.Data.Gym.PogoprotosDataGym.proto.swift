...
public extension Pogoprotos.Data.Gym {
  ...
  final public class GymMembership : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      fileprivate var trainingPokemonBuilder_:Pogoprotos.Data.PokemonData.Builder! {
           didSet {
              builderResult.hasTrainingPokemon = true
           }
      }
      public func getTrainingPokemonBuilder() -> Pogoprotos.Data.PokemonData.Builder {
        if trainingPokemonBuilder_ == nil {
           ...
           if trainingPokemon != nil {
              try! trainingPokemonBuilder_.mergeFrom(other: trainingPokemon)
           }
        }
      ...
      public func mergeFrom(other:Pogoprotos.Data.Gym.GymMembership) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
        ...
        if (other.hasTrainingPokemon) {
            try mergeTrainingPokemon(value: other.trainingPokemon)
        }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
        ...
        while (true) {
          ...
          case 26:
            let subBuilder:Pogoprotos.Data.PokemonData.Builder = Pogoprotos.Data.PokemonData.Builder()
            if hasTrainingPokemon {
              try subBuilder.mergeFrom(other: trainingPokemon)
            }
            try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Gym.GymMembership.Builder {
  ...
  final public class GymState : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Gym.GymState.Builder {
