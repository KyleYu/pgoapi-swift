...
public extension Pogoprotos.Data.Badge {
  ...
  final public class BadgeCaptureReward : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Badge.BadgeCaptureReward, rhs: Pogoprotos.Data.Badge.BadgeCaptureReward) -> Bool {
      ...
      fieldCheck = fieldCheck && (lhs.avatarTemplateIds == rhs.avatarTemplateIds)
    ...
    public fileprivate(set) var avatarTemplateIds:Array<String> = Array<String>()
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if !avatarTemplateIds.isEmpty {
        for oneValueavatarTemplateIds in avatarTemplateIds {
          try codedOutputStream.writeString(fieldNumber: 2, value:oneValueavatarTemplateIds)
        }
      }
    ...
    override public func serializedSize() -> Int32 {
      ...
      var dataSizeAvatarTemplateIds:Int32 = 0
      for oneValueavatarTemplateIds in avatarTemplateIds {
          dataSizeAvatarTemplateIds += oneValueavatarTemplateIds.computeStringSizeNoTag()
      }
      serialize_size += dataSizeAvatarTemplateIds
      serialize_size += 1 * Int32(avatarTemplateIds.count)
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if !avatarTemplateIds.isEmpty {
        var jsonArrayAvatarTemplateIds:Array<String> = []
          for oneValueAvatarTemplateIds in avatarTemplateIds {
            jsonArrayAvatarTemplateIds.append(oneValueAvatarTemplateIds)
          }
        jsonMap["avatarTemplateIds"] = jsonArrayAvatarTemplateIds
      }
      return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
      ...
      var avatarTemplateIdsElementIndex:Int = 0
      for oneValueAvatarTemplateIds in avatarTemplateIds  {
          output += "\(indent) avatarTemplateIds[\(avatarTemplateIdsElementIndex)]: \(oneValueAvatarTemplateIds)\n"
          avatarTemplateIdsElementIndex += 1
      }
    ...
    override public var hashValue:Int {
        get {
            ...
            for oneValueAvatarTemplateIds in avatarTemplateIds {
                hashCode = (hashCode &* 31) &+ oneValueAvatarTemplateIds.hashValue
            }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var avatarTemplateIds:Array<String> {
           get {
               return builderResult.avatarTemplateIds
           }
           set (array) {
               builderResult.avatarTemplateIds = array
           }
      }
      @discardableResult
      public func setAvatarTemplateIds(_ value:Array<String>) -> Pogoprotos.Data.Badge.BadgeCaptureReward.Builder {
        self.avatarTemplateIds = value
        return self
      }
      @discardableResult
      public func clearAvatarTemplateIds() -> Pogoprotos.Data.Badge.BadgeCaptureReward.Builder {
         builderResult.avatarTemplateIds.removeAll(keepingCapacity: false)
         return self
      }
      ...
      public func mergeFrom(other:Pogoprotos.Data.Badge.BadgeCaptureReward) throws -> Pogoprotos.Data.Badge.BadgeCaptureReward.Builder {
        ...
        if !other.avatarTemplateIds.isEmpty {
            builderResult.avatarTemplateIds += other.avatarTemplateIds
        }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Badge.BadgeCaptureReward.Builder {
        ...
        while (true) {
          ...
          case 18:
            avatarTemplateIds += [try codedInputStream.readString()]
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Badge.BadgeCaptureReward.Builder {
        ...
        } else if let jsonValueCaptureRewardMultiplier = jsonMap["captureRewardMultiplier"] as? String {
          resultDecodedBuilder.captureRewardMultiplier = Float(jsonValueCaptureRewardMultiplier)!
        }
        if let jsonValueAvatarTemplateIds = jsonMap["avatarTemplateIds"] as? Array<String> {
          var jsonArrayAvatarTemplateIds:Array<String> = []
          for oneValueAvatarTemplateIds in jsonValueAvatarTemplateIds {
            jsonArrayAvatarTemplateIds.append(oneValueAvatarTemplateIds)
          }
          resultDecodedBuilder.avatarTemplateIds = jsonArrayAvatarTemplateIds
        }
