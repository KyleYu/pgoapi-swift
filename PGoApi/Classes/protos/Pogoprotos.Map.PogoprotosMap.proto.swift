...
public extension Pogoprotos.Map {
  ...
  final public class MapCell : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Map.MapCell.Builder {
        ...
        } else if let jsonValueS2CellId = jsonMap["s2CellId"] as? UInt {
          resultDecodedBuilder.s2CellId = UInt64(jsonValueS2CellId)
        }
        ...
        } else if let jsonValueCurrentTimestampMs = jsonMap["currentTimestampMs"] as? Int {
          resultDecodedBuilder.currentTimestampMs = Int64(jsonValueCurrentTimestampMs)
        }
  ...
  final public class SpawnPoint : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Map.SpawnPoint.Builder {
