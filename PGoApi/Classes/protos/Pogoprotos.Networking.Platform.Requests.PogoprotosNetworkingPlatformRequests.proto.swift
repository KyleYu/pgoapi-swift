...
public extension Pogoprotos.Networking.Platform.Requests {
  ...
  final public class BuyItemAndroidRequest : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Platform.Requests.BuyItemAndroidRequest.Builder {
  ...
  final public class BuyItemPokeCoinsRequest : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Platform.Requests.BuyItemPokeCoinsRequest.Builder {
  ...
  final public class SendEncryptedSignatureRequest : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Platform.Requests.SendEncryptedSignatureRequest.Builder {
  ...
  final public class UnknownPtr8Request : GeneratedMessage {

    public static func == (lhs: Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request, rhs: Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    public class func getBuilder() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
      return Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.classBuilder() as! Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder
    }
    public func getBuilder() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
      return classBuilder() as! Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
      return Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
      return Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder()
    }
    public func toBuilder() throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
      return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
      return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
      guard isInitialized() else {
        throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message")
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
      return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
      return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
      var output = ""
      if hasMessage {
    ...
    override public class func className() -> String {
        return "Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request"
    }
    override public func className() -> String {
        return "Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request"
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
      fileprivate var builderResult:Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request = Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request()
      public func getMessage() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
          return builderResult
      }
      ...
      @discardableResult
      public func setMessage(_ value:String) -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        self.message = value
        return self
      }
      @discardableResult
      public func clearMessage() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder{
      ...
      @discardableResult
      override public func clear() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        builderResult = Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request()
        return self
      }
      override public func clone() throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.builderWithPrototype(prototype:builderResult)
      }
      override public func build() throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
           try checkInitialized()
           return buildPartial()
      }
      public func buildPartial() -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
        let returnMe:Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request = builderResult
        return returnMe
      }
      @discardableResult
      public func mergeFrom(other:Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        if other == Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request() {
         return self
        }
        if other.hasMessage {
      ...
      @discardableResult
      override public func mergeFrom(codedInputStream: CodedInputStream) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
           return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
      }
      @discardableResult
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
        while (true) {
          let protobufTag = try codedInputStream.readTag()
          switch protobufTag {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        let resultDecodedBuilder = Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder()
        if let jsonValueMessage = jsonMap["message"] as? String {
          resultDecodedBuilder.message = jsonValueMessage
        }
        return resultDecodedBuilder
      }
      override class public func fromJSONToBuilder(data:Data) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder {
        let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
        guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
          throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
        }
        return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder.decodeToBuilder(jsonMap:jsDataCast)
      }
    }
...
extension Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request: GeneratedMessageProtocol {
  public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request> {
    var mergedArray = Array<Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request>()
    while let value = try parseDelimitedFrom(inputStream: inputStream) {
      mergedArray.append(value)
    }
    return mergedArray
  }
  public class func parseDelimitedFrom(inputStream: InputStream) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request? {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
  }
  public class func parseFrom(data: Data) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Networking.Platform.Requests.PogoprotosNetworkingPlatformRequestsRoot.default.extensionRegistry).build()
  }
  public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
  }
  public class func parseFrom(inputStream: InputStream) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(inputStream: inputStream).build()
  }
  public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
  }
  public class func parseFrom(codedInputStream: CodedInputStream) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(codedInputStream: codedInputStream).build()
  }
  public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request {
    return try Pogoprotos.Networking.Platform.Requests.UnknownPtr8Request.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
  }
}
