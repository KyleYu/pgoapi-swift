...
public extension Pogoprotos.Networking.Envelopes {
  ...
  final public class AuthTicket : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.AuthTicket.Builder {
        ...
        } else if let jsonValueExpireTimestampMs = jsonMap["expireTimestampMs"] as? UInt {
          resultDecodedBuilder.expireTimestampMs = UInt64(jsonValueExpireTimestampMs)
        }
  ...
  final public class RequestEnvelope : GeneratedMessage {
    ...
    //Nested type declaration start
      ...
      final public class AuthInfo : GeneratedMessage {
        ...
        //Nested type declaration start
          ...
          final public class Jwt : GeneratedMessage {
            ...
            final public class Builder : GeneratedMessageBuilder {
              ...
              class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Jwt.Builder {
                ...
                } else if let jsonValueUnknown2 = jsonMap["unknown2"] as? String {
                  resultDecodedBuilder.unknown2 = Int32(jsonValueUnknown2)!
                }
                return resultDecodedBuilder
              }
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.AuthInfo.Builder {
    ...
    //Nested type declaration start
      ...
      final public class PlatformRequest : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.PlatformRequest.Builder {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.RequestEnvelope.Builder {
        ...
        } else if let jsonValueRequestId = jsonMap["requestId"] as? UInt {
          resultDecodedBuilder.requestId = UInt64(jsonValueRequestId)
        }
        ...
        } else if let jsonValueMsSinceLastLocationfix = jsonMap["msSinceLastLocationfix"] as? Int {
          resultDecodedBuilder.msSinceLastLocationfix = Int64(jsonValueMsSinceLastLocationfix)
        }
        return resultDecodedBuilder
      }
  ...
  final public class ResponseEnvelope : GeneratedMessage {
    ...
    //Nested type declaration start
      ...
      final public class PlatformResponse : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.PlatformResponse.Builder {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 8:
            ...
            if let enumsstatusCode = Pogoprotos.Networking.Envelopes.ResponseEnvelope.StatusCode(rawValue:valueIntstatusCode){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 1, value:Int64(valueIntstatusCode))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.ResponseEnvelope.Builder {
  ...
  final public class Signature : GeneratedMessage {
    ...
    //Nested type declaration start
      ...
      final public class LocationFix : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.LocationFix.Builder {
            ...
            } else if let jsonValueTimestampSnapshot = jsonMap["timestampSnapshot"] as? UInt {
              resultDecodedBuilder.timestampSnapshot = UInt64(jsonValueTimestampSnapshot)
            }
            ...
            } else if let jsonValueCourse = jsonMap["course"] as? String {
              resultDecodedBuilder.course = Float(jsonValueCourse)!
            }
            ...
            } else if let jsonValueVerticalAccuracy = jsonMap["verticalAccuracy"] as? String {
              resultDecodedBuilder.verticalAccuracy = Float(jsonValueVerticalAccuracy)!
            }
            ...
            } else if let jsonValueProviderStatus = jsonMap["providerStatus"] as? UInt {
              resultDecodedBuilder.providerStatus = UInt64(jsonValueProviderStatus)
            }
            if let jsonValueFloor = jsonMap["floor"] as? UInt {
              resultDecodedBuilder.floor = UInt32(jsonValueFloor)
            } else if let jsonValueFloor = jsonMap["floor"] as? String {
              resultDecodedBuilder.floor = UInt32(jsonValueFloor)!
            }
            ...
            } else if let jsonValueLocationType = jsonMap["locationType"] as? UInt {
              resultDecodedBuilder.locationType = UInt64(jsonValueLocationType)
            }
            return resultDecodedBuilder
          }
    ...
    //Nested type declaration start
      ...
      final public class AndroidGpsInfo : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.AndroidGpsInfo.Builder {
            ...
            } else if let jsonValueTimeToFix = jsonMap["timeToFix"] as? UInt {
              resultDecodedBuilder.timeToFix = UInt64(jsonValueTimeToFix)
            }
    ...
    //Nested type declaration start
      ...
      final public class SensorInfo : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.SensorInfo.Builder {
            ...
            } else if let jsonValueLinearAccelerationX = jsonMap["linearAccelerationX"] as? String {
              resultDecodedBuilder.linearAccelerationX = Double(jsonValueLinearAccelerationX)!
            }
            ...
            } else if let jsonValueLinearAccelerationY = jsonMap["linearAccelerationY"] as? String {
              resultDecodedBuilder.linearAccelerationY = Double(jsonValueLinearAccelerationY)!
            }
            ...
            } else if let jsonValueLinearAccelerationZ = jsonMap["linearAccelerationZ"] as? String {
              resultDecodedBuilder.linearAccelerationZ = Double(jsonValueLinearAccelerationZ)!
            }
            ...
            } else if let jsonValueMagneticFieldX = jsonMap["magneticFieldX"] as? String {
              resultDecodedBuilder.magneticFieldX = Double(jsonValueMagneticFieldX)!
            }
            ...
            } else if let jsonValueMagneticFieldY = jsonMap["magneticFieldY"] as? String {
              resultDecodedBuilder.magneticFieldY = Double(jsonValueMagneticFieldY)!
            }
            ...
            } else if let jsonValueMagneticFieldZ = jsonMap["magneticFieldZ"] as? String {
              resultDecodedBuilder.magneticFieldZ = Double(jsonValueMagneticFieldZ)!
            }
            ...
            } else if let jsonValueMagneticFieldAccuracy = jsonMap["magneticFieldAccuracy"] as? String {
              resultDecodedBuilder.magneticFieldAccuracy = Int32(jsonValueMagneticFieldAccuracy)!
            }
            ...
            } else if let jsonValueAttitudePitch = jsonMap["attitudePitch"] as? String {
              resultDecodedBuilder.attitudePitch = Double(jsonValueAttitudePitch)!
            }
            if let jsonValueAttitudeYaw = jsonMap["attitudeYaw"] as? Double {
              resultDecodedBuilder.attitudeYaw = Double(jsonValueAttitudeYaw)
            } else if let jsonValueAttitudeYaw = jsonMap["attitudeYaw"] as? String {
              resultDecodedBuilder.attitudeYaw = Double(jsonValueAttitudeYaw)!
            }
            ...
            } else if let jsonValueAttitudeRoll = jsonMap["attitudeRoll"] as? String {
              resultDecodedBuilder.attitudeRoll = Double(jsonValueAttitudeRoll)!
            }
            ...
            } else if let jsonValueRotationRateX = jsonMap["rotationRateX"] as? String {
              resultDecodedBuilder.rotationRateX = Double(jsonValueRotationRateX)!
            }
            ...
            } else if let jsonValueRotationRateY = jsonMap["rotationRateY"] as? String {
              resultDecodedBuilder.rotationRateY = Double(jsonValueRotationRateY)!
            }
    ...
    //Nested type declaration start
      ...
      final public class DeviceInfo : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.DeviceInfo.Builder {
    ...
    //Nested type declaration start
      ...
      final public class ActivityStatus : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.ActivityStatus.Builder {
            ...
            } else if let jsonValueStartTimeMs = jsonMap["startTimeMs"] as? UInt {
              resultDecodedBuilder.startTimeMs = UInt64(jsonValueStartTimeMs)
            }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasLocationHash1 {
        jsonMap["locationHash1"] = Int(locationHash1)
      }
      if hasField11 {
      ...
      if hasLocationHash2 {
        jsonMap["locationHash2"] = Int(locationHash2)
      }
      if hasField21 {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.Signature.Builder {
        ...
        } else if let jsonValueTimestampSinceStart = jsonMap["timestampSinceStart"] as? UInt {
          resultDecodedBuilder.timestampSinceStart = UInt64(jsonValueTimestampSinceStart)
        }
        ...
        if let jsonValueLocationHash1 = jsonMap["locationHash1"] as? Int {
          resultDecodedBuilder.locationHash1 = Int32(jsonValueLocationHash1)
        } else if let jsonValueLocationHash1 = jsonMap["locationHash1"] as? String {
          resultDecodedBuilder.locationHash1 = Int32(jsonValueLocationHash1)!
        }
        ...
        } else if let jsonValueField13 = jsonMap["field13"] as? String {
          resultDecodedBuilder.field13 = Int32(jsonValueField13)!
        }
        if let jsonValueField14 = jsonMap["field14"] as? Int {
          resultDecodedBuilder.field14 = Int32(jsonValueField14)
        } else if let jsonValueField14 = jsonMap["field14"] as? String {
          resultDecodedBuilder.field14 = Int32(jsonValueField14)!
        }
        ...
        } else if let jsonValueField16 = jsonMap["field16"] as? String {
          resultDecodedBuilder.field16 = Int32(jsonValueField16)!
        }
        ...
        if let jsonValueLocationHash2 = jsonMap["locationHash2"] as? Int {
          resultDecodedBuilder.locationHash2 = Int32(jsonValueLocationHash2)
        } else if let jsonValueLocationHash2 = jsonMap["locationHash2"] as? String {
          resultDecodedBuilder.locationHash2 = Int32(jsonValueLocationHash2)!
        }
        ...
        } else if let jsonValueUnknown25 = jsonMap["unknown25"] as? Int {
          resultDecodedBuilder.unknown25 = Int64(jsonValueUnknown25)
        }
        return resultDecodedBuilder
      }
  ...
  final public class UnknownMessage : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Networking.Envelopes.UnknownMessage.Builder {
