...
public extension Pogoprotos.Data.Quests {
  ...
  final public class DailyQuest : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Quests.DailyQuest.Builder {
        ...
        } else if let jsonValueCurrentPeriodBucket = jsonMap["currentPeriodBucket"] as? String {
          resultDecodedBuilder.currentPeriodBucket = Int32(jsonValueCurrentPeriodBucket)!
        }
        ...
        } else if let jsonValueCurrentStreakCount = jsonMap["currentStreakCount"] as? String {
          resultDecodedBuilder.currentStreakCount = Int32(jsonValueCurrentStreakCount)!
        }
  ...
  final public class Quest : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Quests.Quest.Builder {
