...
public extension Pogoprotos.Data.Player {
  ...
  public enum PlayerAvatarType:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    case playerAvatarMale = 0
    case playerAvatarFemale = 1
    public func toString() -> String {
      switch self {
      case .playerAvatarMale: return "PLAYER_AVATAR_MALE"
      case .playerAvatarFemale: return "PLAYER_AVATAR_FEMALE"
      }
    }
    public static func fromString(str:String) throws -> Pogoprotos.Data.Player.PlayerAvatarType {
      switch str {
      case "PLAYER_AVATAR_MALE":  return .playerAvatarMale
      case "PLAYER_AVATAR_FEMALE":  return .playerAvatarFemale
    ...
    private func getDescription() -> String { 
      switch self {
      case .playerAvatarMale: return ".playerAvatarMale"
      case .playerAvatarFemale: return ".playerAvatarFemale"
      }
    }
  }
  ...
  final public class ContactSettings : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.ContactSettings.Builder {
  ...
  final public class Currency : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.Currency.Builder {
  ...
  final public class DailyBonus : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.DailyBonus.Builder {
        ...
        } else if let jsonValueNextCollectedTimestampMs = jsonMap["nextCollectedTimestampMs"] as? Int {
          resultDecodedBuilder.nextCollectedTimestampMs = Int64(jsonValueNextCollectedTimestampMs)
        }
        ...
        } else if let jsonValueNextDefenderBonusCollectTimestampMs = jsonMap["nextDefenderBonusCollectTimestampMs"] as? Int {
          resultDecodedBuilder.nextDefenderBonusCollectTimestampMs = Int64(jsonValueNextDefenderBonusCollectTimestampMs)
        }
        return resultDecodedBuilder
      }
  ...
  final public class EquippedBadge : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.EquippedBadge.Builder {
        ...
        } else if let jsonValueNextEquipChangeAllowedTimestampMs = jsonMap["nextEquipChangeAllowedTimestampMs"] as? Int {
          resultDecodedBuilder.nextEquipChangeAllowedTimestampMs = Int64(jsonValueNextEquipChangeAllowedTimestampMs)
        }
        return resultDecodedBuilder
      }
  ...
  final public class PlayerAvatar : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Player.PlayerAvatar, rhs: Pogoprotos.Data.Player.PlayerAvatar) -> Bool {
      ...
      fieldCheck = fieldCheck && (lhs.hasAvatarHair == rhs.hasAvatarHair) && (!lhs.hasAvatarHair || lhs.avatarHair == rhs.avatarHair)
      fieldCheck = fieldCheck && (lhs.hasAvatarShirt == rhs.hasAvatarShirt) && (!lhs.hasAvatarShirt || lhs.avatarShirt == rhs.avatarShirt)
      fieldCheck = fieldCheck && (lhs.hasAvatarPants == rhs.hasAvatarPants) && (!lhs.hasAvatarPants || lhs.avatarPants == rhs.avatarPants)
      fieldCheck = fieldCheck && (lhs.hasAvatarHat == rhs.hasAvatarHat) && (!lhs.hasAvatarHat || lhs.avatarHat == rhs.avatarHat)
      fieldCheck = fieldCheck && (lhs.hasAvatarShoes == rhs.hasAvatarShoes) && (!lhs.hasAvatarShoes || lhs.avatarShoes == rhs.avatarShoes)
      fieldCheck = fieldCheck && (lhs.hasAvatarEyes == rhs.hasAvatarEyes) && (!lhs.hasAvatarEyes || lhs.avatarEyes == rhs.avatarEyes)
      fieldCheck = fieldCheck && (lhs.hasAvatarBackpack == rhs.hasAvatarBackpack) && (!lhs.hasAvatarBackpack || lhs.avatarBackpack == rhs.avatarBackpack)
      fieldCheck = fieldCheck && (lhs.hasAvatarGloves == rhs.hasAvatarGloves) && (!lhs.hasAvatarGloves || lhs.avatarGloves == rhs.avatarGloves)
      fieldCheck = fieldCheck && (lhs.hasAvatarSocks == rhs.hasAvatarSocks) && (!lhs.hasAvatarSocks || lhs.avatarSocks == rhs.avatarSocks)
      fieldCheck = fieldCheck && (lhs.hasAvatarBelt == rhs.hasAvatarBelt) && (!lhs.hasAvatarBelt || lhs.avatarBelt == rhs.avatarBelt)
      fieldCheck = fieldCheck && (lhs.hasAvatarGlasses == rhs.hasAvatarGlasses) && (!lhs.hasAvatarGlasses || lhs.avatarGlasses == rhs.avatarGlasses)
      fieldCheck = fieldCheck && (lhs.hasAvatarNecklace == rhs.hasAvatarNecklace) && (!lhs.hasAvatarNecklace || lhs.avatarNecklace == rhs.avatarNecklace)
      fieldCheck = (fieldCheck && (lhs.unknownFields == rhs.unknownFields))
      return fieldCheck
    }
    ...
    public fileprivate(set) var avatar:Int32 = Int32(0)
    ...
    public fileprivate(set) var avatarHair:String = ""
    public fileprivate(set) var hasAvatarHair:Bool = false

    public fileprivate(set) var avatarShirt:String = ""
    public fileprivate(set) var hasAvatarShirt:Bool = false

    public fileprivate(set) var avatarPants:String = ""
    public fileprivate(set) var hasAvatarPants:Bool = false

    public fileprivate(set) var avatarHat:String = ""
    public fileprivate(set) var hasAvatarHat:Bool = false

    public fileprivate(set) var avatarShoes:String = ""
    public fileprivate(set) var hasAvatarShoes:Bool = false

    public fileprivate(set) var avatarEyes:String = ""
    public fileprivate(set) var hasAvatarEyes:Bool = false

    public fileprivate(set) var avatarBackpack:String = ""
    public fileprivate(set) var hasAvatarBackpack:Bool = false

    public fileprivate(set) var avatarGloves:String = ""
    public fileprivate(set) var hasAvatarGloves:Bool = false

    public fileprivate(set) var avatarSocks:String = ""
    public fileprivate(set) var hasAvatarSocks:Bool = false

    public fileprivate(set) var avatarBelt:String = ""
    public fileprivate(set) var hasAvatarBelt:Bool = false

    public fileprivate(set) var avatarGlasses:String = ""
    public fileprivate(set) var hasAvatarGlasses:Bool = false

    public fileprivate(set) var avatarNecklace:String = ""
    public fileprivate(set) var hasAvatarNecklace:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasAvatar {
        try codedOutputStream.writeInt32(fieldNumber: 8, value:avatar)
      }
      if hasEyes {
      ...
      if hasAvatarHair {
        try codedOutputStream.writeString(fieldNumber: 11, value:avatarHair)
      }
      if hasAvatarShirt {
        try codedOutputStream.writeString(fieldNumber: 12, value:avatarShirt)
      }
      if hasAvatarPants {
        try codedOutputStream.writeString(fieldNumber: 13, value:avatarPants)
      }
      if hasAvatarHat {
        try codedOutputStream.writeString(fieldNumber: 14, value:avatarHat)
      }
      if hasAvatarShoes {
        try codedOutputStream.writeString(fieldNumber: 15, value:avatarShoes)
      }
      if hasAvatarEyes {
        try codedOutputStream.writeString(fieldNumber: 16, value:avatarEyes)
      }
      if hasAvatarBackpack {
        try codedOutputStream.writeString(fieldNumber: 17, value:avatarBackpack)
      }
      if hasAvatarGloves {
        try codedOutputStream.writeString(fieldNumber: 18, value:avatarGloves)
      }
      if hasAvatarSocks {
        try codedOutputStream.writeString(fieldNumber: 19, value:avatarSocks)
      }
      if hasAvatarBelt {
        try codedOutputStream.writeString(fieldNumber: 20, value:avatarBelt)
      }
      if hasAvatarGlasses {
        try codedOutputStream.writeString(fieldNumber: 21, value:avatarGlasses)
      }
      if hasAvatarNecklace {
        try codedOutputStream.writeString(fieldNumber: 22, value:avatarNecklace)
      }
      try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
      ...
      if hasAvatar {
        serialize_size += avatar.computeInt32Size(fieldNumber: 8)
      }
      if hasEyes {
      ...
      if hasAvatarHair {
        serialize_size += avatarHair.computeStringSize(fieldNumber: 11)
      }
      if hasAvatarShirt {
        serialize_size += avatarShirt.computeStringSize(fieldNumber: 12)
      }
      if hasAvatarPants {
        serialize_size += avatarPants.computeStringSize(fieldNumber: 13)
      }
      if hasAvatarHat {
        serialize_size += avatarHat.computeStringSize(fieldNumber: 14)
      }
      if hasAvatarShoes {
        serialize_size += avatarShoes.computeStringSize(fieldNumber: 15)
      }
      if hasAvatarEyes {
        serialize_size += avatarEyes.computeStringSize(fieldNumber: 16)
      }
      if hasAvatarBackpack {
        serialize_size += avatarBackpack.computeStringSize(fieldNumber: 17)
      }
      if hasAvatarGloves {
        serialize_size += avatarGloves.computeStringSize(fieldNumber: 18)
      }
      if hasAvatarSocks {
        serialize_size += avatarSocks.computeStringSize(fieldNumber: 19)
      }
      if hasAvatarBelt {
        serialize_size += avatarBelt.computeStringSize(fieldNumber: 20)
      }
      if hasAvatarGlasses {
        serialize_size += avatarGlasses.computeStringSize(fieldNumber: 21)
      }
      if hasAvatarNecklace {
        serialize_size += avatarNecklace.computeStringSize(fieldNumber: 22)
      }
      serialize_size += unknownFields.serializedSize()
      memoizedSerializedSize = serialize_size
      return serialize_size
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasAvatarHair {
        jsonMap["avatarHair"] = avatarHair
      }
      if hasAvatarShirt {
        jsonMap["avatarShirt"] = avatarShirt
      }
      if hasAvatarPants {
        jsonMap["avatarPants"] = avatarPants
      }
      if hasAvatarHat {
        jsonMap["avatarHat"] = avatarHat
      }
      if hasAvatarShoes {
        jsonMap["avatarShoes"] = avatarShoes
      }
      if hasAvatarEyes {
        jsonMap["avatarEyes"] = avatarEyes
      }
      if hasAvatarBackpack {
        jsonMap["avatarBackpack"] = avatarBackpack
      }
      if hasAvatarGloves {
        jsonMap["avatarGloves"] = avatarGloves
      }
      if hasAvatarSocks {
        jsonMap["avatarSocks"] = avatarSocks
      }
      if hasAvatarBelt {
        jsonMap["avatarBelt"] = avatarBelt
      }
      if hasAvatarGlasses {
        jsonMap["avatarGlasses"] = avatarGlasses
      }
      if hasAvatarNecklace {
        jsonMap["avatarNecklace"] = avatarNecklace
      }
      return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
      ...
      if hasAvatarHair {
        output += "\(indent) avatarHair: \(avatarHair) \n"
      }
      if hasAvatarShirt {
        output += "\(indent) avatarShirt: \(avatarShirt) \n"
      }
      if hasAvatarPants {
        output += "\(indent) avatarPants: \(avatarPants) \n"
      }
      if hasAvatarHat {
        output += "\(indent) avatarHat: \(avatarHat) \n"
      }
      if hasAvatarShoes {
        output += "\(indent) avatarShoes: \(avatarShoes) \n"
      }
      if hasAvatarEyes {
        output += "\(indent) avatarEyes: \(avatarEyes) \n"
      }
      if hasAvatarBackpack {
        output += "\(indent) avatarBackpack: \(avatarBackpack) \n"
      }
      if hasAvatarGloves {
        output += "\(indent) avatarGloves: \(avatarGloves) \n"
      }
      if hasAvatarSocks {
        output += "\(indent) avatarSocks: \(avatarSocks) \n"
      }
      if hasAvatarBelt {
        output += "\(indent) avatarBelt: \(avatarBelt) \n"
      }
      if hasAvatarGlasses {
        output += "\(indent) avatarGlasses: \(avatarGlasses) \n"
      }
      if hasAvatarNecklace {
        output += "\(indent) avatarNecklace: \(avatarNecklace) \n"
      }
      output += unknownFields.getDescription(indent: indent)
      return output
    }
    override public var hashValue:Int {
        get {
            ...
            if hasAvatarHair {
               hashCode = (hashCode &* 31) &+ avatarHair.hashValue
            }
            if hasAvatarShirt {
               hashCode = (hashCode &* 31) &+ avatarShirt.hashValue
            }
            if hasAvatarPants {
               hashCode = (hashCode &* 31) &+ avatarPants.hashValue
            }
            if hasAvatarHat {
               hashCode = (hashCode &* 31) &+ avatarHat.hashValue
            }
            if hasAvatarShoes {
               hashCode = (hashCode &* 31) &+ avatarShoes.hashValue
            }
            if hasAvatarEyes {
               hashCode = (hashCode &* 31) &+ avatarEyes.hashValue
            }
            if hasAvatarBackpack {
               hashCode = (hashCode &* 31) &+ avatarBackpack.hashValue
            }
            if hasAvatarGloves {
               hashCode = (hashCode &* 31) &+ avatarGloves.hashValue
            }
            if hasAvatarSocks {
               hashCode = (hashCode &* 31) &+ avatarSocks.hashValue
            }
            if hasAvatarBelt {
               hashCode = (hashCode &* 31) &+ avatarBelt.hashValue
            }
            if hasAvatarGlasses {
               hashCode = (hashCode &* 31) &+ avatarGlasses.hashValue
            }
            if hasAvatarNecklace {
               hashCode = (hashCode &* 31) &+ avatarNecklace.hashValue
            }
            hashCode = (hashCode &* 31) &+  unknownFields.hashValue
            return hashCode
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      public func setAvatar(_ value:Int32) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatar = value
        return self
      }
      @discardableResult
      public func clearAvatar() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatar = false
           builderResult.avatar = Int32(0)
           return self
      }
      ...
      public var avatarHair:String {
           get {
                return builderResult.avatarHair
           }
           set (value) {
               builderResult.hasAvatarHair = true
               builderResult.avatarHair = value
           }
      }
      public var hasAvatarHair:Bool {
           get {
                return builderResult.hasAvatarHair
           }
      }
      @discardableResult
      public func setAvatarHair(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarHair = value
        return self
      }
      @discardableResult
      public func clearAvatarHair() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarHair = false
           builderResult.avatarHair = ""
           return self
      }
      public var avatarShirt:String {
           get {
                return builderResult.avatarShirt
           }
           set (value) {
               builderResult.hasAvatarShirt = true
               builderResult.avatarShirt = value
           }
      }
      public var hasAvatarShirt:Bool {
           get {
                return builderResult.hasAvatarShirt
           }
      }
      @discardableResult
      public func setAvatarShirt(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarShirt = value
        return self
      }
      @discardableResult
      public func clearAvatarShirt() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarShirt = false
           builderResult.avatarShirt = ""
           return self
      }
      public var avatarPants:String {
           get {
                return builderResult.avatarPants
           }
           set (value) {
               builderResult.hasAvatarPants = true
               builderResult.avatarPants = value
           }
      }
      public var hasAvatarPants:Bool {
           get {
                return builderResult.hasAvatarPants
           }
      }
      @discardableResult
      public func setAvatarPants(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarPants = value
        return self
      }
      @discardableResult
      public func clearAvatarPants() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarPants = false
           builderResult.avatarPants = ""
           return self
      }
      public var avatarHat:String {
           get {
                return builderResult.avatarHat
           }
           set (value) {
               builderResult.hasAvatarHat = true
               builderResult.avatarHat = value
           }
      }
      public var hasAvatarHat:Bool {
           get {
                return builderResult.hasAvatarHat
           }
      }
      @discardableResult
      public func setAvatarHat(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarHat = value
        return self
      }
      @discardableResult
      public func clearAvatarHat() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarHat = false
           builderResult.avatarHat = ""
           return self
      }
      public var avatarShoes:String {
           get {
                return builderResult.avatarShoes
           }
           set (value) {
               builderResult.hasAvatarShoes = true
               builderResult.avatarShoes = value
           }
      }
      public var hasAvatarShoes:Bool {
           get {
                return builderResult.hasAvatarShoes
           }
      }
      @discardableResult
      public func setAvatarShoes(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarShoes = value
        return self
      }
      @discardableResult
      public func clearAvatarShoes() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarShoes = false
           builderResult.avatarShoes = ""
           return self
      }
      public var avatarEyes:String {
           get {
                return builderResult.avatarEyes
           }
           set (value) {
               builderResult.hasAvatarEyes = true
               builderResult.avatarEyes = value
           }
      }
      public var hasAvatarEyes:Bool {
           get {
                return builderResult.hasAvatarEyes
           }
      }
      @discardableResult
      public func setAvatarEyes(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarEyes = value
        return self
      }
      @discardableResult
      public func clearAvatarEyes() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarEyes = false
           builderResult.avatarEyes = ""
           return self
      }
      public var avatarBackpack:String {
           get {
                return builderResult.avatarBackpack
           }
           set (value) {
               builderResult.hasAvatarBackpack = true
               builderResult.avatarBackpack = value
           }
      }
      public var hasAvatarBackpack:Bool {
           get {
                return builderResult.hasAvatarBackpack
           }
      }
      @discardableResult
      public func setAvatarBackpack(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarBackpack = value
        return self
      }
      @discardableResult
      public func clearAvatarBackpack() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarBackpack = false
           builderResult.avatarBackpack = ""
           return self
      }
      public var avatarGloves:String {
           get {
                return builderResult.avatarGloves
           }
           set (value) {
               builderResult.hasAvatarGloves = true
               builderResult.avatarGloves = value
           }
      }
      public var hasAvatarGloves:Bool {
           get {
                return builderResult.hasAvatarGloves
           }
      }
      @discardableResult
      public func setAvatarGloves(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarGloves = value
        return self
      }
      @discardableResult
      public func clearAvatarGloves() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarGloves = false
           builderResult.avatarGloves = ""
           return self
      }
      public var avatarSocks:String {
           get {
                return builderResult.avatarSocks
           }
           set (value) {
               builderResult.hasAvatarSocks = true
               builderResult.avatarSocks = value
           }
      }
      public var hasAvatarSocks:Bool {
           get {
                return builderResult.hasAvatarSocks
           }
      }
      @discardableResult
      public func setAvatarSocks(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarSocks = value
        return self
      }
      @discardableResult
      public func clearAvatarSocks() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarSocks = false
           builderResult.avatarSocks = ""
           return self
      }
      public var avatarBelt:String {
           get {
                return builderResult.avatarBelt
           }
           set (value) {
               builderResult.hasAvatarBelt = true
               builderResult.avatarBelt = value
           }
      }
      public var hasAvatarBelt:Bool {
           get {
                return builderResult.hasAvatarBelt
           }
      }
      @discardableResult
      public func setAvatarBelt(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarBelt = value
        return self
      }
      @discardableResult
      public func clearAvatarBelt() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarBelt = false
           builderResult.avatarBelt = ""
           return self
      }
      public var avatarGlasses:String {
           get {
                return builderResult.avatarGlasses
           }
           set (value) {
               builderResult.hasAvatarGlasses = true
               builderResult.avatarGlasses = value
           }
      }
      public var hasAvatarGlasses:Bool {
           get {
                return builderResult.hasAvatarGlasses
           }
      }
      @discardableResult
      public func setAvatarGlasses(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarGlasses = value
        return self
      }
      @discardableResult
      public func clearAvatarGlasses() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarGlasses = false
           builderResult.avatarGlasses = ""
           return self
      }
      public var avatarNecklace:String {
           get {
                return builderResult.avatarNecklace
           }
           set (value) {
               builderResult.hasAvatarNecklace = true
               builderResult.avatarNecklace = value
           }
      }
      public var hasAvatarNecklace:Bool {
           get {
                return builderResult.hasAvatarNecklace
           }
      }
      @discardableResult
      public func setAvatarNecklace(_ value:String) -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        self.avatarNecklace = value
        return self
      }
      @discardableResult
      public func clearAvatarNecklace() -> Pogoprotos.Data.Player.PlayerAvatar.Builder{
           builderResult.hasAvatarNecklace = false
           builderResult.avatarNecklace = ""
           return self
      }
      override public var internalGetResult:GeneratedMessage {
           get {
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        ...
        while (true) {
          ...
          case 64:
            avatar = try codedInputStream.readInt32()
          ...
          case 90:
            avatarHair = try codedInputStream.readString()

          case 98:
            avatarShirt = try codedInputStream.readString()

          case 106:
            avatarPants = try codedInputStream.readString()

          case 114:
            avatarHat = try codedInputStream.readString()

          case 122:
            avatarShoes = try codedInputStream.readString()

          case 130:
            avatarEyes = try codedInputStream.readString()

          case 138:
            avatarBackpack = try codedInputStream.readString()

          case 146:
            avatarGloves = try codedInputStream.readString()

          case 154:
            avatarSocks = try codedInputStream.readString()

          case 162:
            avatarBelt = try codedInputStream.readString()

          case 170:
            avatarGlasses = try codedInputStream.readString()

          case 178:
            avatarNecklace = try codedInputStream.readString()
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.PlayerAvatar.Builder {
        ...
        } else if let jsonValueSkin = jsonMap["skin"] as? String {
          resultDecodedBuilder.skin = Int32(jsonValueSkin)!
        }
        if let jsonValueHair = jsonMap["hair"] as? Int {
          resultDecodedBuilder.hair = Int32(jsonValueHair)
        } else if let jsonValueHair = jsonMap["hair"] as? String {
          resultDecodedBuilder.hair = Int32(jsonValueHair)!
        }
        if let jsonValueShirt = jsonMap["shirt"] as? Int {
          resultDecodedBuilder.shirt = Int32(jsonValueShirt)
        } else if let jsonValueShirt = jsonMap["shirt"] as? String {
          resultDecodedBuilder.shirt = Int32(jsonValueShirt)!
        }
        if let jsonValuePants = jsonMap["pants"] as? Int {
          resultDecodedBuilder.pants = Int32(jsonValuePants)
        } else if let jsonValuePants = jsonMap["pants"] as? String {
          resultDecodedBuilder.pants = Int32(jsonValuePants)!
        }
        if let jsonValueHat = jsonMap["hat"] as? Int {
          resultDecodedBuilder.hat = Int32(jsonValueHat)
        } else if let jsonValueHat = jsonMap["hat"] as? String {
          resultDecodedBuilder.hat = Int32(jsonValueHat)!
        }
        if let jsonValueShoes = jsonMap["shoes"] as? Int {
          resultDecodedBuilder.shoes = Int32(jsonValueShoes)
        } else if let jsonValueShoes = jsonMap["shoes"] as? String {
          resultDecodedBuilder.shoes = Int32(jsonValueShoes)!
        }
        if let jsonValueAvatar = jsonMap["avatar"] as? Int {
          resultDecodedBuilder.avatar = Int32(jsonValueAvatar)
        } else if let jsonValueAvatar = jsonMap["avatar"] as? String {
          resultDecodedBuilder.avatar = Int32(jsonValueAvatar)!
        }
        if let jsonValueEyes = jsonMap["eyes"] as? Int {
          resultDecodedBuilder.eyes = Int32(jsonValueEyes)
        } else if let jsonValueEyes = jsonMap["eyes"] as? String {
          resultDecodedBuilder.eyes = Int32(jsonValueEyes)!
        }
        if let jsonValueBackpack = jsonMap["backpack"] as? Int {
          resultDecodedBuilder.backpack = Int32(jsonValueBackpack)
        } else if let jsonValueBackpack = jsonMap["backpack"] as? String {
          resultDecodedBuilder.backpack = Int32(jsonValueBackpack)!
        }
        if let jsonValueAvatarHair = jsonMap["avatarHair"] as? String {
          resultDecodedBuilder.avatarHair = jsonValueAvatarHair
        }
        if let jsonValueAvatarShirt = jsonMap["avatarShirt"] as? String {
          resultDecodedBuilder.avatarShirt = jsonValueAvatarShirt
        }
        if let jsonValueAvatarPants = jsonMap["avatarPants"] as? String {
          resultDecodedBuilder.avatarPants = jsonValueAvatarPants
        }
        if let jsonValueAvatarHat = jsonMap["avatarHat"] as? String {
          resultDecodedBuilder.avatarHat = jsonValueAvatarHat
        }
        if let jsonValueAvatarShoes = jsonMap["avatarShoes"] as? String {
          resultDecodedBuilder.avatarShoes = jsonValueAvatarShoes
        }
        if let jsonValueAvatarEyes = jsonMap["avatarEyes"] as? String {
          resultDecodedBuilder.avatarEyes = jsonValueAvatarEyes
        }
        if let jsonValueAvatarBackpack = jsonMap["avatarBackpack"] as? String {
          resultDecodedBuilder.avatarBackpack = jsonValueAvatarBackpack
        }
        if let jsonValueAvatarGloves = jsonMap["avatarGloves"] as? String {
          resultDecodedBuilder.avatarGloves = jsonValueAvatarGloves
        }
        if let jsonValueAvatarSocks = jsonMap["avatarSocks"] as? String {
          resultDecodedBuilder.avatarSocks = jsonValueAvatarSocks
        }
        if let jsonValueAvatarBelt = jsonMap["avatarBelt"] as? String {
          resultDecodedBuilder.avatarBelt = jsonValueAvatarBelt
        }
        if let jsonValueAvatarGlasses = jsonMap["avatarGlasses"] as? String {
          resultDecodedBuilder.avatarGlasses = jsonValueAvatarGlasses
        }
        if let jsonValueAvatarNecklace = jsonMap["avatarNecklace"] as? String {
          resultDecodedBuilder.avatarNecklace = jsonValueAvatarNecklace
        }
        return resultDecodedBuilder
      }
  ...
  final public class PlayerCamera : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.PlayerCamera.Builder {
  ...
  final public class PlayerCurrency : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.PlayerCurrency.Builder {
        ...
        } else if let jsonValueGems = jsonMap["gems"] as? String {
          resultDecodedBuilder.gems = Int32(jsonValueGems)!
        }
        return resultDecodedBuilder
      }
  ...
  final public class PlayerPublicProfile : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.PlayerPublicProfile.Builder {
  ...
  final public class PlayerStats : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Player.PlayerStats, rhs: Pogoprotos.Data.Player.PlayerStats) -> Bool {
      ...
      fieldCheck = fieldCheck && (lhs.hasUsedKmPool == rhs.hasUsedKmPool) && (!lhs.hasUsedKmPool || lhs.usedKmPool == rhs.usedKmPool)
      fieldCheck = fieldCheck && (lhs.hasLastKmRefillMs == rhs.hasLastKmRefillMs) && (!lhs.hasLastKmRefillMs || lhs.lastKmRefillMs == rhs.lastKmRefillMs)
      fieldCheck = (fieldCheck && (lhs.unknownFields == rhs.unknownFields))
      return fieldCheck
    }
    ...
    public fileprivate(set) var usedKmPool:Double = Double(0)
    public fileprivate(set) var hasUsedKmPool:Bool = false

    public fileprivate(set) var lastKmRefillMs:Int64 = Int64(0)
    public fileprivate(set) var hasLastKmRefillMs:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasUsedKmPool {
        try codedOutputStream.writeDouble(fieldNumber: 24, value:usedKmPool)
      }
      if hasLastKmRefillMs {
        try codedOutputStream.writeInt64(fieldNumber: 25, value:lastKmRefillMs)
      }
      try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
      ...
      if hasUsedKmPool {
        serialize_size += usedKmPool.computeDoubleSize(fieldNumber: 24)
      }
      if hasLastKmRefillMs {
        serialize_size += lastKmRefillMs.computeInt64Size(fieldNumber: 25)
      }
      serialize_size += unknownFields.serializedSize()
      memoizedSerializedSize = serialize_size
      return serialize_size
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasUsedKmPool {
        jsonMap["usedKmPool"] = Double(usedKmPool)
      }
      if hasLastKmRefillMs {
        jsonMap["lastKmRefillMs"] = "\(lastKmRefillMs)"
      }
      return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
      ...
      if hasUsedKmPool {
        output += "\(indent) usedKmPool: \(usedKmPool) \n"
      }
      if hasLastKmRefillMs {
        output += "\(indent) lastKmRefillMs: \(lastKmRefillMs) \n"
      }
      output += unknownFields.getDescription(indent: indent)
      return output
    }
    override public var hashValue:Int {
        get {
            ...
            if hasUsedKmPool {
               hashCode = (hashCode &* 31) &+ usedKmPool.hashValue
            }
            if hasLastKmRefillMs {
               hashCode = (hashCode &* 31) &+ lastKmRefillMs.hashValue
            }
            hashCode = (hashCode &* 31) &+  unknownFields.hashValue
            return hashCode
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var usedKmPool:Double {
           get {
                return builderResult.usedKmPool
           }
           set (value) {
               builderResult.hasUsedKmPool = true
               builderResult.usedKmPool = value
           }
      }
      public var hasUsedKmPool:Bool {
           get {
                return builderResult.hasUsedKmPool
           }
      }
      @discardableResult
      public func setUsedKmPool(_ value:Double) -> Pogoprotos.Data.Player.PlayerStats.Builder {
        self.usedKmPool = value
        return self
      }
      @discardableResult
      public func clearUsedKmPool() -> Pogoprotos.Data.Player.PlayerStats.Builder{
           builderResult.hasUsedKmPool = false
           builderResult.usedKmPool = Double(0)
           return self
      }
      public var lastKmRefillMs:Int64 {
           get {
                return builderResult.lastKmRefillMs
           }
           set (value) {
               builderResult.hasLastKmRefillMs = true
               builderResult.lastKmRefillMs = value
           }
      }
      public var hasLastKmRefillMs:Bool {
           get {
                return builderResult.hasLastKmRefillMs
           }
      }
      @discardableResult
      public func setLastKmRefillMs(_ value:Int64) -> Pogoprotos.Data.Player.PlayerStats.Builder {
        self.lastKmRefillMs = value
        return self
      }
      @discardableResult
      public func clearLastKmRefillMs() -> Pogoprotos.Data.Player.PlayerStats.Builder{
           builderResult.hasLastKmRefillMs = false
           builderResult.lastKmRefillMs = Int64(0)
           return self
      }
      override public var internalGetResult:GeneratedMessage {
           get {
      ...
      public func mergeFrom(other:Pogoprotos.Data.Player.PlayerStats) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        ...
        if other.hasUsedKmPool {
             usedKmPool = other.usedKmPool
        }
        if other.hasLastKmRefillMs {
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        ...
        while (true) {
          ...
          case 193:
            usedKmPool = try codedInputStream.readDouble()

          case 200:
            lastKmRefillMs = try codedInputStream.readInt64()
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Player.PlayerStats.Builder {
        ...
        } else if let jsonValuePokemonsEncountered = jsonMap["pokemonsEncountered"] as? String {
          resultDecodedBuilder.pokemonsEncountered = Int32(jsonValuePokemonsEncountered)!
        }
        ...
        } else if let jsonValueUniquePokedexEntries = jsonMap["uniquePokedexEntries"] as? String {
          resultDecodedBuilder.uniquePokedexEntries = Int32(jsonValueUniquePokedexEntries)!
        }
        ...
        } else if let jsonValuePokemonsCaptured = jsonMap["pokemonsCaptured"] as? String {
          resultDecodedBuilder.pokemonsCaptured = Int32(jsonValuePokemonsCaptured)!
        }
        if let jsonValueEvolutions = jsonMap["evolutions"] as? Int {
          resultDecodedBuilder.evolutions = Int32(jsonValueEvolutions)
        } else if let jsonValueEvolutions = jsonMap["evolutions"] as? String {
          resultDecodedBuilder.evolutions = Int32(jsonValueEvolutions)!
        }
        ...
        } else if let jsonValuePokeStopVisits = jsonMap["pokeStopVisits"] as? String {
          resultDecodedBuilder.pokeStopVisits = Int32(jsonValuePokeStopVisits)!
        }
        ...
        } else if let jsonValuePokeballsThrown = jsonMap["pokeballsThrown"] as? String {
          resultDecodedBuilder.pokeballsThrown = Int32(jsonValuePokeballsThrown)!
        }
        if let jsonValueEggsHatched = jsonMap["eggsHatched"] as? Int {
          resultDecodedBuilder.eggsHatched = Int32(jsonValueEggsHatched)
        } else if let jsonValueEggsHatched = jsonMap["eggsHatched"] as? String {
          resultDecodedBuilder.eggsHatched = Int32(jsonValueEggsHatched)!
        }
        ...
        } else if let jsonValueBigMagikarpCaught = jsonMap["bigMagikarpCaught"] as? String {
          resultDecodedBuilder.bigMagikarpCaught = Int32(jsonValueBigMagikarpCaught)!
        }
        ...
        } else if let jsonValueBattleAttackWon = jsonMap["battleAttackWon"] as? String {
          resultDecodedBuilder.battleAttackWon = Int32(jsonValueBattleAttackWon)!
        }
        ...
        } else if let jsonValueBattleAttackTotal = jsonMap["battleAttackTotal"] as? String {
          resultDecodedBuilder.battleAttackTotal = Int32(jsonValueBattleAttackTotal)!
        }
        ...
        } else if let jsonValueBattleDefendedWon = jsonMap["battleDefendedWon"] as? String {
          resultDecodedBuilder.battleDefendedWon = Int32(jsonValueBattleDefendedWon)!
        }
        ...
        } else if let jsonValueBattleTrainingWon = jsonMap["battleTrainingWon"] as? String {
          resultDecodedBuilder.battleTrainingWon = Int32(jsonValueBattleTrainingWon)!
        }
        ...
        } else if let jsonValueBattleTrainingTotal = jsonMap["battleTrainingTotal"] as? String {
          resultDecodedBuilder.battleTrainingTotal = Int32(jsonValueBattleTrainingTotal)!
        }
        ...
        } else if let jsonValuePrestigeRaisedTotal = jsonMap["prestigeRaisedTotal"] as? String {
          resultDecodedBuilder.prestigeRaisedTotal = Int32(jsonValuePrestigeRaisedTotal)!
        }
        ...
        } else if let jsonValuePrestigeDroppedTotal = jsonMap["prestigeDroppedTotal"] as? String {
          resultDecodedBuilder.prestigeDroppedTotal = Int32(jsonValuePrestigeDroppedTotal)!
        }
        ...
        } else if let jsonValuePokemonDeployed = jsonMap["pokemonDeployed"] as? String {
          resultDecodedBuilder.pokemonDeployed = Int32(jsonValuePokemonDeployed)!
        }
        ...
        } else if let jsonValueSmallRattataCaught = jsonMap["smallRattataCaught"] as? String {
          resultDecodedBuilder.smallRattataCaught = Int32(jsonValueSmallRattataCaught)!
        }
        if let jsonValueUsedKmPool = jsonMap["usedKmPool"] as? Double {
          resultDecodedBuilder.usedKmPool = Double(jsonValueUsedKmPool)
        } else if let jsonValueUsedKmPool = jsonMap["usedKmPool"] as? String {
          resultDecodedBuilder.usedKmPool = Double(jsonValueUsedKmPool)!
        }
        if let jsonValueLastKmRefillMs = jsonMap["lastKmRefillMs"] as? String {
          resultDecodedBuilder.lastKmRefillMs = Int64(jsonValueLastKmRefillMs)!
        } else if let jsonValueLastKmRefillMs = jsonMap["lastKmRefillMs"] as? Int {
          resultDecodedBuilder.lastKmRefillMs = Int64(jsonValueLastKmRefillMs)
        }
        return resultDecodedBuilder
      }
