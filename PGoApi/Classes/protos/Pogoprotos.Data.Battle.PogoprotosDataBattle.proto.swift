...
public extension Pogoprotos.Data.Battle {
  public struct PogoprotosDataBattleRoot {
    public static let `default` = PogoprotosDataBattleRoot()
  ...
  final public class BattleAction : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Battle.BattleAction, rhs: Pogoprotos.Data.Battle.BattleAction) -> Bool {
      if (lhs === rhs) {
        return true
      }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasAttackerIndex {
        jsonMap["attackerIndex"] = Int(attackerIndex)
      }
      if hasTargetIndex {
        jsonMap["targetIndex"] = Int(targetIndex)
      }
      if hasActivePokemonId {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func getPlayerJoinedBuilder() -> Pogoprotos.Data.Battle.BattleParticipant.Builder {
        if playerJoinedBuilder_ == nil {
           ...
           builderResult.playerJoined = playerJoinedBuilder_.getMessage()
           if playerJoined != nil {
              try! playerJoinedBuilder_.mergeFrom(other: playerJoined)
           }
        }
      ...
      public func getBattleResultsBuilder() -> Pogoprotos.Data.Battle.BattleResults.Builder {
        if battleResultsBuilder_ == nil {
           ...
           if battleResults != nil {
              try! battleResultsBuilder_.mergeFrom(other: battleResults)
           }
        }
      ...
      public func getPlayerLeftBuilder() -> Pogoprotos.Data.Battle.BattleParticipant.Builder {
        if playerLeftBuilder_ == nil {
           ...
           builderResult.playerLeft = playerLeftBuilder_.getMessage()
           if playerLeft != nil {
              try! playerLeftBuilder_.mergeFrom(other: playerLeft)
           }
        }
      ...
      public func mergeFrom(other:Pogoprotos.Data.Battle.BattleAction) throws -> Pogoprotos.Data.Battle.BattleAction.Builder {
        ...
        if (other.hasPlayerJoined) {
            try mergePlayerJoined(value: other.playerJoined)
        }
        if (other.hasBattleResults) {
            try mergeBattleResults(value: other.battleResults)
        }
        ...
        if (other.hasPlayerLeft) {
            try mergePlayerLeft(value: other.playerLeft)
        }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Battle.BattleAction.Builder {
        ...
        while (true) {
          ...
          case 74:
            ...
            if hasPlayerJoined {
              try subBuilder.mergeFrom(other: playerJoined)
            }
          ...
          case 82:
            ...
            if hasBattleResults {
              try subBuilder.mergeFrom(other: battleResults)
            }
            try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
          ...
          case 106:
            let subBuilder:Pogoprotos.Data.Battle.BattleParticipant.Builder = Pogoprotos.Data.Battle.BattleParticipant.Builder()
            if hasPlayerLeft {
              try subBuilder.mergeFrom(other: playerLeft)
            }
            try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Battle.BattleAction.Builder {
        ...
        } else if let jsonValueActionStartMs = jsonMap["actionStartMs"] as? Int {
          resultDecodedBuilder.actionStartMs = Int64(jsonValueActionStartMs)
        }
        ...
        if let jsonValueAttackerIndex = jsonMap["attackerIndex"] as? Int {
          resultDecodedBuilder.attackerIndex = Int32(jsonValueAttackerIndex)
        } else if let jsonValueAttackerIndex = jsonMap["attackerIndex"] as? String {
          resultDecodedBuilder.attackerIndex = Int32(jsonValueAttackerIndex)!
        }
        if let jsonValueTargetIndex = jsonMap["targetIndex"] as? Int {
          resultDecodedBuilder.targetIndex = Int32(jsonValueTargetIndex)
        } else if let jsonValueTargetIndex = jsonMap["targetIndex"] as? String {
          resultDecodedBuilder.targetIndex = Int32(jsonValueTargetIndex)!
        }
        ...
        } else if let jsonValueActivePokemonId = jsonMap["activePokemonId"] as? UInt {
          resultDecodedBuilder.activePokemonId = UInt64(jsonValueActivePokemonId)
        }
        ...
        } else if let jsonValueDamageWindowsStartTimestampMs = jsonMap["damageWindowsStartTimestampMs"] as? Int {
          resultDecodedBuilder.damageWindowsStartTimestampMs = Int64(jsonValueDamageWindowsStartTimestampMs)
        }
        ...
        } else if let jsonValueDamageWindowsEndTimestampMs = jsonMap["damageWindowsEndTimestampMs"] as? Int {
          resultDecodedBuilder.damageWindowsEndTimestampMs = Int64(jsonValueDamageWindowsEndTimestampMs)
        }
        ...
        } else if let jsonValueTargetPokemonId = jsonMap["targetPokemonId"] as? UInt {
          resultDecodedBuilder.targetPokemonId = UInt64(jsonValueTargetPokemonId)
        }
  ...
  final public class BattleLog : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Battle.BattleLog, rhs: Pogoprotos.Data.Battle.BattleLog) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 16:
            ...
            if let enumsbattleType = Pogoprotos.Data.Battle.BattleType(rawValue:valueIntbattleType){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 2, value:Int64(valueIntbattleType))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Battle.BattleLog.Builder {
        ...
        } else if let jsonValueServerMs = jsonMap["serverMs"] as? Int {
          resultDecodedBuilder.serverMs = Int64(jsonValueServerMs)
        }
        ...
        } else if let jsonValueBattleStartTimestampMs = jsonMap["battleStartTimestampMs"] as? Int {
          resultDecodedBuilder.battleStartTimestampMs = Int64(jsonValueBattleStartTimestampMs)
        }
        ...
        } else if let jsonValueBattleEndTimestampMs = jsonMap["battleEndTimestampMs"] as? Int {
          resultDecodedBuilder.battleEndTimestampMs = Int64(jsonValueBattleEndTimestampMs)
        }
        return resultDecodedBuilder
      }
  ...
  final public class BattleParticipant : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Battle.BattleParticipant, rhs: Pogoprotos.Data.Battle.BattleParticipant) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func getActivePokemonBuilder() -> Pogoprotos.Data.Battle.BattlePokemonInfo.Builder {
        if activePokemonBuilder_ == nil {
           ...
           if activePokemon != nil {
              try! activePokemonBuilder_.mergeFrom(other: activePokemon)
           }
        }
      ...
      public func mergeFrom(other:Pogoprotos.Data.Battle.BattleParticipant) throws -> Pogoprotos.Data.Battle.BattleParticipant.Builder {
        ...
        if (other.hasActivePokemon) {
            try mergeActivePokemon(value: other.activePokemon)
        }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Data.Battle.BattleParticipant.Builder {
        ...
        while (true) {
          ...
          case 10:
            ...
            if hasActivePokemon {
              try subBuilder.mergeFrom(other: activePokemon)
            }
            try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Battle.BattleParticipant.Builder {
  ...
  final public class BattlePokemonInfo : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Battle.BattlePokemonInfo, rhs: Pogoprotos.Data.Battle.BattlePokemonInfo) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasCurrentHealth {
        jsonMap["currentHealth"] = Int(currentHealth)
      }
      if hasCurrentEnergy {
        jsonMap["currentEnergy"] = Int(currentEnergy)
      }
      return jsonMap
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Battle.BattlePokemonInfo.Builder {
        ...
        if let jsonValueCurrentHealth = jsonMap["currentHealth"] as? Int {
          resultDecodedBuilder.currentHealth = Int32(jsonValueCurrentHealth)
        } else if let jsonValueCurrentHealth = jsonMap["currentHealth"] as? String {
          resultDecodedBuilder.currentHealth = Int32(jsonValueCurrentHealth)!
        }
        if let jsonValueCurrentEnergy = jsonMap["currentEnergy"] as? Int {
          resultDecodedBuilder.currentEnergy = Int32(jsonValueCurrentEnergy)
        } else if let jsonValueCurrentEnergy = jsonMap["currentEnergy"] as? String {
          resultDecodedBuilder.currentEnergy = Int32(jsonValueCurrentEnergy)!
        }
        return resultDecodedBuilder
      }
  ...
  final public class BattleResults : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Battle.BattleResults, rhs: Pogoprotos.Data.Battle.BattleResults) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if !playerExperienceAwarded.isEmpty {
        var jsonArrayPlayerExperienceAwarded:Array<Int> = []
          for oneValuePlayerExperienceAwarded in playerExperienceAwarded {
            jsonArrayPlayerExperienceAwarded.append(Int(oneValuePlayerExperienceAwarded))
          }
      ...
      if hasGymPointsDelta {
        jsonMap["gymPointsDelta"] = Int(gymPointsDelta)
      }
      return jsonMap
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Battle.BattleResults.Builder {
        ...
        if let jsonValuePlayerExperienceAwarded = jsonMap["playerExperienceAwarded"] as? Array<Int> {
          var jsonArrayPlayerExperienceAwarded:Array<Int32> = []
          for oneValuePlayerExperienceAwarded in jsonValuePlayerExperienceAwarded {
            jsonArrayPlayerExperienceAwarded.append(Int32(oneValuePlayerExperienceAwarded))
          }
        ...
        } else if let jsonValueNextDefenderPokemonId = jsonMap["nextDefenderPokemonId"] as? Int {
          resultDecodedBuilder.nextDefenderPokemonId = Int64(jsonValueNextDefenderPokemonId)
        }
        if let jsonValueGymPointsDelta = jsonMap["gymPointsDelta"] as? Int {
          resultDecodedBuilder.gymPointsDelta = Int32(jsonValueGymPointsDelta)
        } else if let jsonValueGymPointsDelta = jsonMap["gymPointsDelta"] as? String {
          resultDecodedBuilder.gymPointsDelta = Int32(jsonValueGymPointsDelta)!
        }
        return resultDecodedBuilder
      }
...
extension Pogoprotos.Data.Battle.BattleAction: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Battle.BattleAction {
    return try Pogoprotos.Data.Battle.BattleAction.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Battle.PogoprotosDataBattleRoot.default.extensionRegistry).build()
  }
...
extension Pogoprotos.Data.Battle.BattleLog: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Battle.BattleLog {
    return try Pogoprotos.Data.Battle.BattleLog.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Battle.PogoprotosDataBattleRoot.default.extensionRegistry).build()
  }
...
extension Pogoprotos.Data.Battle.BattleParticipant: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Battle.BattleParticipant {
    return try Pogoprotos.Data.Battle.BattleParticipant.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Battle.PogoprotosDataBattleRoot.default.extensionRegistry).build()
  }
...
extension Pogoprotos.Data.Battle.BattlePokemonInfo: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Battle.BattlePokemonInfo {
    return try Pogoprotos.Data.Battle.BattlePokemonInfo.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Battle.PogoprotosDataBattleRoot.default.extensionRegistry).build()
  }
...
extension Pogoprotos.Data.Battle.BattleResults: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Battle.BattleResults {
    return try Pogoprotos.Data.Battle.BattleResults.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Battle.PogoprotosDataBattleRoot.default.extensionRegistry).build()
  }
