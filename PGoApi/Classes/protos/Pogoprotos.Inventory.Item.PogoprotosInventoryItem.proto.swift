...
public extension Pogoprotos.Inventory.Item {
  ...
  public enum ItemId:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public func toString() -> String {
      ...
      case .itemSunStone: return "ITEM_SUN_STONE"
      case .itemKingsRock: return "ITEM_KINGS_ROCK"
      case .itemMetalCoat: return "ITEM_METAL_COAT"
      case .itemDragonScale: return "ITEM_DRAGON_SCALE"
      case .itemUpGrade: return "ITEM_UP_GRADE"
      }
    }
    public static func fromString(str:String) throws -> Pogoprotos.Inventory.Item.ItemId {
      ...
      case "ITEM_SUN_STONE":  return .itemSunStone
      case "ITEM_KINGS_ROCK":  return .itemKingsRock
      case "ITEM_METAL_COAT":  return .itemMetalCoat
      case "ITEM_DRAGON_SCALE":  return .itemDragonScale
      case "ITEM_UP_GRADE":  return .itemUpGrade
    ...
    private func getDescription() -> String { 
      ...
      case .itemSunStone: return ".itemSunStone"
      case .itemKingsRock: return ".itemKingsRock"
      case .itemMetalCoat: return ".itemMetalCoat"
      case .itemDragonScale: return ".itemDragonScale"
      case .itemUpGrade: return ".itemUpGrade"
      }
    }
  }
  ...
  public enum ItemType:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    case itemTypeEvolutionRequirement = 13
    public func toString() -> String {
      switch self {
      ...
      case .itemTypeEvolutionRequirement: return "ITEM_TYPE_EVOLUTION_REQUIREMENT"
      }
    }
    public static func fromString(str:String) throws -> Pogoprotos.Inventory.Item.ItemType {
      ...
      case "ITEM_TYPE_EVOLUTION_REQUIREMENT":  return .itemTypeEvolutionRequirement
      default: throw ProtocolBuffersError.invalidProtocolBuffer("Conversion String to Enum has failed.")
      }
    }
    public var debugDescription:String { return getDescription() }
    ...
    private func getDescription() -> String { 
      ...
      case .itemTypeEvolutionRequirement: return ".itemTypeEvolutionRequirement"
      }
    }
  }
  ...
  final public class ItemAward : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Inventory.Item.ItemAward, rhs: Pogoprotos.Inventory.Item.ItemAward) -> Bool {
      ...
      fieldCheck = fieldCheck && (lhs.hasBonusCount == rhs.hasBonusCount) && (!lhs.hasBonusCount || lhs.bonusCount == rhs.bonusCount)
    ...
    public fileprivate(set) var bonusCount:Int32 = Int32(0)
    public fileprivate(set) var hasBonusCount:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasBonusCount {
        try codedOutputStream.writeInt32(fieldNumber: 3, value:bonusCount)
      }
    ...
    override public func serializedSize() -> Int32 {
      ...
      if hasBonusCount {
        serialize_size += bonusCount.computeInt32Size(fieldNumber: 3)
      }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasBonusCount {
        jsonMap["bonusCount"] = Int(bonusCount)
      }
      return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
      ...
      if hasBonusCount {
        output += "\(indent) bonusCount: \(bonusCount) \n"
      }
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasBonusCount {
               hashCode = (hashCode &* 31) &+ bonusCount.hashValue
            }
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var bonusCount:Int32 {
           get {
                return builderResult.bonusCount
           }
           set (value) {
               builderResult.hasBonusCount = true
               builderResult.bonusCount = value
           }
      }
      public var hasBonusCount:Bool {
           get {
                return builderResult.hasBonusCount
           }
      }
      @discardableResult
      public func setBonusCount(_ value:Int32) -> Pogoprotos.Inventory.Item.ItemAward.Builder {
        self.bonusCount = value
        return self
      }
      @discardableResult
      public func clearBonusCount() -> Pogoprotos.Inventory.Item.ItemAward.Builder{
           builderResult.hasBonusCount = false
           builderResult.bonusCount = Int32(0)
           return self
      }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Inventory.Item.ItemAward.Builder {
        ...
        while (true) {
          ...
          case 24:
            bonusCount = try codedInputStream.readInt32()
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.Item.ItemAward.Builder {
        ...
        } else if let jsonValueItemCount = jsonMap["itemCount"] as? String {
          resultDecodedBuilder.itemCount = Int32(jsonValueItemCount)!
        }
        if let jsonValueBonusCount = jsonMap["bonusCount"] as? Int {
          resultDecodedBuilder.bonusCount = Int32(jsonValueBonusCount)
        } else if let jsonValueBonusCount = jsonMap["bonusCount"] as? String {
          resultDecodedBuilder.bonusCount = Int32(jsonValueBonusCount)!
        }
  ...
  final public class ItemData : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.Item.ItemData.Builder {
