...
public extension Pogoprotos.Networking.Platform {
  public struct PogoprotosNetworkingPlatformRoot {
    public static let `default` = PogoprotosNetworkingPlatformRoot()
  ...
  public enum PlatformRequestType:Int32, CustomDebugStringConvertible, CustomStringConvertible {
    ...
    public func toString() -> String {
      ...
      case .unknownPtr8: return "UNKNOWN_PTR_8"
      }
    }
    public static func fromString(str:String) throws -> Pogoprotos.Networking.Platform.PlatformRequestType {
      ...
      case "UNKNOWN_PTR_8":  return .unknownPtr8
    ...
    private func getDescription() -> String { 
      ...
      case .unknownPtr8: return ".unknownPtr8"
      }
    }
  }
