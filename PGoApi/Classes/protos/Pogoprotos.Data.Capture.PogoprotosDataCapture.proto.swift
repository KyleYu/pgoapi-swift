...
public extension Pogoprotos.Data.Capture {
  public struct PogoprotosDataCaptureRoot {
    public static let `default` = PogoprotosDataCaptureRoot()
  ...
  final public class CaptureAward : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Capture.CaptureAward, rhs: Pogoprotos.Data.Capture.CaptureAward) -> Bool {
      if (lhs === rhs) {
        return true
      }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if !xp.isEmpty {
        var jsonArrayXp:Array<Int> = []
          for oneValueXp in xp {
            jsonArrayXp.append(Int(oneValueXp))
          }
        jsonMap["xp"] = jsonArrayXp
      }
      if !candy.isEmpty {
        var jsonArrayCandy:Array<Int> = []
          for oneValueCandy in candy {
            jsonArrayCandy.append(Int(oneValueCandy))
          }
        jsonMap["candy"] = jsonArrayCandy
      }
      if !stardust.isEmpty {
        var jsonArrayStardust:Array<Int> = []
          for oneValueStardust in stardust {
            jsonArrayStardust.append(Int(oneValueStardust))
          }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 10:
            ...
            if let enumsactivityType = Pogoprotos.Enums.ActivityType(rawValue:valueIntactivityType) {
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 1, value:Int64(valueIntactivityType))
            }
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Capture.CaptureAward.Builder {
  ...
  final public class CaptureProbability : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Data.Capture.CaptureProbability, rhs: Pogoprotos.Data.Capture.CaptureProbability) -> Bool {
      if (lhs === rhs) {
        return true
      }
      var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if !captureProbability.isEmpty {
        var jsonArrayCaptureProbability:Array<Float> = []
          for oneValueCaptureProbability in captureProbability {
            jsonArrayCaptureProbability.append(Float(oneValueCaptureProbability))
          }
        jsonMap["captureProbability"] = jsonArrayCaptureProbability
      }
      if hasReticleDifficultyScale {
        jsonMap["reticleDifficultyScale"] = Double(reticleDifficultyScale)
      }
      return jsonMap
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 10:
            ...
            if let enumspokeballType = Pogoprotos.Inventory.Item.ItemId(rawValue:valueIntpokeballType) {
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 1, value:Int64(valueIntpokeballType))
            }
            }
            codedInputStream.popLimit(oldLimit: oldLimit)
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Data.Capture.CaptureProbability.Builder {
        ...
        if let jsonValueCaptureProbability = jsonMap["captureProbability"] as? Array<Float> {
          var jsonArrayCaptureProbability:Array<Float> = []
        ...
        if let jsonValueReticleDifficultyScale = jsonMap["reticleDifficultyScale"] as? Double {
          resultDecodedBuilder.reticleDifficultyScale = Double(jsonValueReticleDifficultyScale)
        } else if let jsonValueReticleDifficultyScale = jsonMap["reticleDifficultyScale"] as? String {
          resultDecodedBuilder.reticleDifficultyScale = Double(jsonValueReticleDifficultyScale)!
        }
        return resultDecodedBuilder
      }
...
extension Pogoprotos.Data.Capture.CaptureAward: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Capture.CaptureAward {
    return try Pogoprotos.Data.Capture.CaptureAward.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Capture.PogoprotosDataCaptureRoot.default.extensionRegistry).build()
  }
...
extension Pogoprotos.Data.Capture.CaptureProbability: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Data.Capture.CaptureProbability {
    return try Pogoprotos.Data.Capture.CaptureProbability.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Data.Capture.PogoprotosDataCaptureRoot.default.extensionRegistry).build()
  }
