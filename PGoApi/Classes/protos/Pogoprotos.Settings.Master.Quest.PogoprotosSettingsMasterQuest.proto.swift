...
public extension Pogoprotos.Settings.Master.Quest {
  public struct PogoprotosSettingsMasterQuestRoot {
    public static let `default` = PogoprotosSettingsMasterQuestRoot()
  ...
  final public class DailyQuestSettings : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Settings.Master.Quest.DailyQuestSettings, rhs: Pogoprotos.Settings.Master.Quest.DailyQuestSettings) -> Bool {
      if (lhs === rhs) {
        return true
      }
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasBucketsPerDay {
        jsonMap["bucketsPerDay"] = Int(bucketsPerDay)
      }
      if hasStreakLength {
        jsonMap["streakLength"] = Int(streakLength)
      }
      if hasBonusMultiplier {
        jsonMap["bonusMultiplier"] = Float(bonusMultiplier)
      }
      if hasStreakBonusMultiplier {
        jsonMap["streakBonusMultiplier"] = Float(streakBonusMultiplier)
      }
      return jsonMap
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
      fileprivate var builderResult:Pogoprotos.Settings.Master.Quest.DailyQuestSettings = Pogoprotos.Settings.Master.Quest.DailyQuestSettings()
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Settings.Master.Quest.DailyQuestSettings.Builder {
        let resultDecodedBuilder = Pogoprotos.Settings.Master.Quest.DailyQuestSettings.Builder()
        if let jsonValueBucketsPerDay = jsonMap["bucketsPerDay"] as? Int {
          resultDecodedBuilder.bucketsPerDay = Int32(jsonValueBucketsPerDay)
        } else if let jsonValueBucketsPerDay = jsonMap["bucketsPerDay"] as? String {
          resultDecodedBuilder.bucketsPerDay = Int32(jsonValueBucketsPerDay)!
        }
        if let jsonValueStreakLength = jsonMap["streakLength"] as? Int {
          resultDecodedBuilder.streakLength = Int32(jsonValueStreakLength)
        } else if let jsonValueStreakLength = jsonMap["streakLength"] as? String {
          resultDecodedBuilder.streakLength = Int32(jsonValueStreakLength)!
        }
        if let jsonValueBonusMultiplier = jsonMap["bonusMultiplier"] as? Float {
          resultDecodedBuilder.bonusMultiplier = Float(jsonValueBonusMultiplier)
        } else if let jsonValueBonusMultiplier = jsonMap["bonusMultiplier"] as? String {
          resultDecodedBuilder.bonusMultiplier = Float(jsonValueBonusMultiplier)!
        }
        if let jsonValueStreakBonusMultiplier = jsonMap["streakBonusMultiplier"] as? Float {
          resultDecodedBuilder.streakBonusMultiplier = Float(jsonValueStreakBonusMultiplier)
        } else if let jsonValueStreakBonusMultiplier = jsonMap["streakBonusMultiplier"] as? String {
          resultDecodedBuilder.streakBonusMultiplier = Float(jsonValueStreakBonusMultiplier)!
        }
...
extension Pogoprotos.Settings.Master.Quest.DailyQuestSettings: GeneratedMessageProtocol {
  ...
  public class func parseFrom(data: Data) throws -> Pogoprotos.Settings.Master.Quest.DailyQuestSettings {
    return try Pogoprotos.Settings.Master.Quest.DailyQuestSettings.Builder().mergeFrom(data: data, extensionRegistry:Pogoprotos.Settings.Master.Quest.PogoprotosSettingsMasterQuestRoot.default.extensionRegistry).build()
  }
