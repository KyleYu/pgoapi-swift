...
public extension Pogoprotos.Map.Pokemon {
  ...
  final public class MapPokemon : GeneratedMessage {
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasPokemonDisplay {
        try codedOutputStream.writeMessage(fieldNumber: 7, value:pokemonDisplay)
      }
    ...
    override public func serializedSize() -> Int32 {
      ...
      if hasPokemonDisplay {
          if let varSizepokemonDisplay = pokemonDisplay?.computeMessageSize(fieldNumber: 7) {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      public func setPokemonDisplay(_ value:Pogoprotos.Data.PokemonDisplay!) -> Pogoprotos.Map.Pokemon.MapPokemon.Builder {
        self.pokemonDisplay = value
        return self
      }
      @discardableResult
      public func mergePokemonDisplay(value:Pogoprotos.Data.PokemonDisplay) throws -> Pogoprotos.Map.Pokemon.MapPokemon.Builder {
      ...
      @discardableResult
      public func clearPokemonDisplay() -> Pogoprotos.Map.Pokemon.MapPokemon.Builder {
        ...
        while (true) {
          ...
          case 24:
            ...
            if let enumspokemonId = Pogoprotos.Enums.PokemonId(rawValue:valueIntpokemonId){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 3, value:Int64(valueIntpokemonId))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Map.Pokemon.MapPokemon.Builder {
  ...
  final public class NearbyPokemon : GeneratedMessage {
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasPokemonDisplay {
        try codedOutputStream.writeMessage(fieldNumber: 6, value:pokemonDisplay)
      }
      try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
      ...
      if hasPokemonDisplay {
          if let varSizepokemonDisplay = pokemonDisplay?.computeMessageSize(fieldNumber: 6) {
              serialize_size += varSizepokemonDisplay
          }
      }
      serialize_size += unknownFields.serializedSize()
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      public func setPokemonDisplay(_ value:Pogoprotos.Data.PokemonDisplay!) -> Pogoprotos.Map.Pokemon.NearbyPokemon.Builder {
        self.pokemonDisplay = value
        return self
      }
      @discardableResult
      public func mergePokemonDisplay(value:Pogoprotos.Data.PokemonDisplay) throws -> Pogoprotos.Map.Pokemon.NearbyPokemon.Builder {
        if builderResult.hasPokemonDisplay {
          builderResult.pokemonDisplay = try Pogoprotos.Data.PokemonDisplay.builderWithPrototype(prototype:builderResult.pokemonDisplay).mergeFrom(other: value).buildPartial()
        } else {
          builderResult.pokemonDisplay = value
      ...
      @discardableResult
      public func clearPokemonDisplay() -> Pogoprotos.Map.Pokemon.NearbyPokemon.Builder {
        pokemonDisplayBuilder_ = nil
        builderResult.hasPokemonDisplay = false
        builderResult.pokemonDisplay = nil
        return self
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Map.Pokemon.NearbyPokemon.Builder {
        ...
        } else if let jsonValueDistanceInMeters = jsonMap["distanceInMeters"] as? String {
          resultDecodedBuilder.distanceInMeters = Float(jsonValueDistanceInMeters)!
        }
        if let jsonValueEncounterId = jsonMap["encounterId"] as? String {
          resultDecodedBuilder.encounterId = UInt64(jsonValueEncounterId)!
  ...
  final public class WildPokemon : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Map.Pokemon.WildPokemon.Builder {
        ...
        } else if let jsonValueTimeTillHiddenMs = jsonMap["timeTillHiddenMs"] as? String {
          resultDecodedBuilder.timeTillHiddenMs = Int32(jsonValueTimeTillHiddenMs)!
        }
        return resultDecodedBuilder
      }
