...
public extension Pogoprotos.Inventory {
  public struct PogoprotosInventoryRoot {
    ...
    init() {
      ...
      Pogoprotos.Data.Avatar.PogoprotosDataAvatarRoot.default.registerAllExtensions(registry: extensionRegistry)
  ...
  final public class AppliedItem : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.AppliedItem.Builder {
        ...
        } else if let jsonValueExpireMs = jsonMap["expireMs"] as? Int {
          resultDecodedBuilder.expireMs = Int64(jsonValueExpireMs)
        }
        if let jsonValueAppliedMs = jsonMap["appliedMs"] as? String {
          resultDecodedBuilder.appliedMs = Int64(jsonValueAppliedMs)!
        } else if let jsonValueAppliedMs = jsonMap["appliedMs"] as? Int {
          resultDecodedBuilder.appliedMs = Int64(jsonValueAppliedMs)
        }
  ...
  final public class AppliedItems : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.AppliedItems.Builder {
  ...
  final public class Candy : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 8:
            ...
            if let enumsfamilyId = Pogoprotos.Enums.PokemonFamilyId(rawValue:valueIntfamilyId){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 1, value:Int64(valueIntfamilyId))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.Candy.Builder {
        ...
        } else if let jsonValueCandy = jsonMap["candy"] as? String {
          resultDecodedBuilder.candy = Int32(jsonValueCandy)!
        }
        return resultDecodedBuilder
      }
  ...
  final public class EggIncubator : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 16:
            ...
            if let enumsitemId = Pogoprotos.Inventory.Item.ItemId(rawValue:valueIntitemId){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 2, value:Int64(valueIntitemId))
            }
          ...
          case 24:
            ...
            if let enumsincubatorType = Pogoprotos.Inventory.EggIncubatorType(rawValue:valueIntincubatorType){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 3, value:Int64(valueIntincubatorType))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.EggIncubator.Builder {
        ...
        } else if let jsonValueUsesRemaining = jsonMap["usesRemaining"] as? String {
          resultDecodedBuilder.usesRemaining = Int32(jsonValueUsesRemaining)!
        }
        ...
        } else if let jsonValueTargetKmWalked = jsonMap["targetKmWalked"] as? String {
          resultDecodedBuilder.targetKmWalked = Double(jsonValueTargetKmWalked)!
        }
        return resultDecodedBuilder
      }
  ...
  final public class EggIncubators : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.EggIncubators.Builder {
  ...
  final public class InventoryDelta : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryDelta.Builder {
        ...
        } else if let jsonValueOriginalTimestampMs = jsonMap["originalTimestampMs"] as? Int {
          resultDecodedBuilder.originalTimestampMs = Int64(jsonValueOriginalTimestampMs)
        }
  ...
  final public class InventoryItem : GeneratedMessage {
    ...
    //Nested type declaration start
      ...
      final public class DeletedItem : GeneratedMessage {
        ...
        final public class Builder : GeneratedMessageBuilder {
          ...
          class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryItem.DeletedItem.Builder {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryItem.Builder {
        ...
        } else if let jsonValueModifiedTimestampMs = jsonMap["modifiedTimestampMs"] as? Int {
          resultDecodedBuilder.modifiedTimestampMs = Int64(jsonValueModifiedTimestampMs)
        }
  ...
  final public class InventoryItemData : GeneratedMessage {
    ...
    public static func == (lhs: Pogoprotos.Inventory.InventoryItemData, rhs: Pogoprotos.Inventory.InventoryItemData) -> Bool {
      ...
      fieldCheck = fieldCheck && (lhs.hasAvatarItem == rhs.hasAvatarItem) && (!lhs.hasAvatarItem || lhs.avatarItem == rhs.avatarItem)
      fieldCheck = (fieldCheck && (lhs.unknownFields == rhs.unknownFields))
      return fieldCheck
    }
    ...
    public fileprivate(set) var avatarItem:Pogoprotos.Data.Avatar.AvatarItem!
    public fileprivate(set) var hasAvatarItem:Bool = false
    required public init() {
         super.init()
    }
    override public func isInitialized() -> Bool {
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasAvatarItem {
        try codedOutputStream.writeMessage(fieldNumber: 12, value:avatarItem)
      }
      try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
      ...
      if hasAvatarItem {
          if let varSizeavatarItem = avatarItem?.computeMessageSize(fieldNumber: 12) {
              serialize_size += varSizeavatarItem
          }
      }
      serialize_size += unknownFields.serializedSize()
      memoizedSerializedSize = serialize_size
    ...
    override public func encode() throws -> Dictionary<String,Any> {
      ...
      if hasAvatarItem {
        jsonMap["avatarItem"] = try avatarItem.encode()
      }
      return jsonMap
    }
    ...
    override public func getDescription(indent:String) throws -> String {
      ...
      if hasAvatarItem {
        output += "\(indent) avatarItem {\n"
        if let outDescAvatarItem = avatarItem {
          output += try outDescAvatarItem.getDescription(indent: "\(indent)  ")
        }
        output += "\(indent) }\n"
      }
      output += unknownFields.getDescription(indent: indent)
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasAvatarItem {
                if let hashValueavatarItem = avatarItem?.hashValue {
                    hashCode = (hashCode &* 31) &+ hashValueavatarItem
                }
            }
            hashCode = (hashCode &* 31) &+  unknownFields.hashValue
            return hashCode
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public var avatarItem:Pogoprotos.Data.Avatar.AvatarItem! {
           get {
               if avatarItemBuilder_ != nil {
                  builderResult.avatarItem = avatarItemBuilder_.getMessage()
               }
               return builderResult.avatarItem
           }
           set (value) {
               builderResult.hasAvatarItem = true
               builderResult.avatarItem = value
           }
      }
      public var hasAvatarItem:Bool {
           get {
               return builderResult.hasAvatarItem
           }
      }
      fileprivate var avatarItemBuilder_:Pogoprotos.Data.Avatar.AvatarItem.Builder! {
           didSet {
              builderResult.hasAvatarItem = true
           }
      }
      public func getAvatarItemBuilder() -> Pogoprotos.Data.Avatar.AvatarItem.Builder {
        if avatarItemBuilder_ == nil {
           avatarItemBuilder_ = Pogoprotos.Data.Avatar.AvatarItem.Builder()
           builderResult.avatarItem = avatarItemBuilder_.getMessage()
           if avatarItem != nil {
              try! avatarItemBuilder_.mergeFrom(other: avatarItem)
           }
        }
        return avatarItemBuilder_
      }
      @discardableResult
      public func setAvatarItem(_ value:Pogoprotos.Data.Avatar.AvatarItem!) -> Pogoprotos.Inventory.InventoryItemData.Builder {
        self.avatarItem = value
        return self
      }
      @discardableResult
      public func mergeAvatarItem(value:Pogoprotos.Data.Avatar.AvatarItem) throws -> Pogoprotos.Inventory.InventoryItemData.Builder {
        if builderResult.hasAvatarItem {
          builderResult.avatarItem = try Pogoprotos.Data.Avatar.AvatarItem.builderWithPrototype(prototype:builderResult.avatarItem).mergeFrom(other: value).buildPartial()
        } else {
          builderResult.avatarItem = value
        }
        builderResult.hasAvatarItem = true
      ...
      @discardableResult
      public func clearAvatarItem() -> Pogoprotos.Inventory.InventoryItemData.Builder {
        avatarItemBuilder_ = nil
        builderResult.hasAvatarItem = false
        builderResult.avatarItem = nil
        return self
      }
      override public var internalGetResult:GeneratedMessage {
           get {
      ...
      public func mergeFrom(other:Pogoprotos.Inventory.InventoryItemData) throws -> Pogoprotos.Inventory.InventoryItemData.Builder {
        ...
        if (other.hasAvatarItem) {
            try mergeAvatarItem(value: other.avatarItem)
        }
        try merge(unknownField: other.unknownFields)
        return self
      }
      ...
      override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Pogoprotos.Inventory.InventoryItemData.Builder {
        ...
        while (true) {
          ...
          case 98:
            let subBuilder:Pogoprotos.Data.Avatar.AvatarItem.Builder = Pogoprotos.Data.Avatar.AvatarItem.Builder()
            if hasAvatarItem {
              try subBuilder.mergeFrom(other: avatarItem)
            }
            try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
            avatarItem = subBuilder.buildPartial()
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryItemData.Builder {
        ...
        if let jsonValueAvatarItem = jsonMap["avatarItem"] as? Dictionary<String,Any> {
          resultDecodedBuilder.avatarItem = try Pogoprotos.Data.Avatar.AvatarItem.Builder.decodeToBuilder(jsonMap:jsonValueAvatarItem).build()
  ...
  final public class InventoryKey : GeneratedMessage {
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
      ...
      if hasAvatarTemplateId {
        try codedOutputStream.writeString(fieldNumber: 12, value:avatarTemplateId)
      }
      try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
      ...
      if hasAvatarTemplateId {
        serialize_size += avatarTemplateId.computeStringSize(fieldNumber: 12)
      }
      serialize_size += unknownFields.serializedSize()
      memoizedSerializedSize = serialize_size
      return serialize_size
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      @discardableResult
      public func setAvatarTemplateId(_ value:String) -> Pogoprotos.Inventory.InventoryKey.Builder {
        self.avatarTemplateId = value
        return self
      }
      @discardableResult
      public func clearAvatarTemplateId() -> Pogoprotos.Inventory.InventoryKey.Builder{
        ...
        while (true) {
          ...
          case 16:
            ...
            if let enumsitem = Pogoprotos.Inventory.Item.ItemId(rawValue:valueIntitem){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 2, value:Int64(valueIntitem))
            }
          ...
          case 80:
            ...
            if let enumspokemonFamilyId = Pogoprotos.Enums.PokemonFamilyId(rawValue:valueIntpokemonFamilyId){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 10, value:Int64(valueIntpokemonFamilyId))
            }
          ...
          case 88:
            ...
            if let enumsquestType = Pogoprotos.Enums.QuestType(rawValue:valueIntquestType){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 11, value:Int64(valueIntquestType))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryKey.Builder {
        ...
        } else if let jsonValuePokedexEntryId = jsonMap["pokedexEntryId"] as? String {
          resultDecodedBuilder.pokedexEntryId = Int32(jsonValuePokedexEntryId)!
        }
  ...
  final public class InventoryUpgrade : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        while (true) {
          ...
          case 16:
            ...
            if let enumsupgradeType = Pogoprotos.Inventory.InventoryUpgradeType(rawValue:valueIntupgradeType){
                 ...
                 try unknownFieldsBuilder.mergeVarintField(fieldNumber: 2, value:Int64(valueIntupgradeType))
            }
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryUpgrade.Builder {
        ...
        } else if let jsonValueAdditionalStorage = jsonMap["additionalStorage"] as? String {
          resultDecodedBuilder.additionalStorage = Int32(jsonValueAdditionalStorage)!
        }
        return resultDecodedBuilder
      }
  ...
  final public class InventoryUpgrades : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> Pogoprotos.Inventory.InventoryUpgrades.Builder {
